...
{
    private readonly ZstEntityEvents m_events;
    ...
    {
        m_events?.on_publish_entity_update_events?.Invoke(entity);
    }

    public override void on_register_entity(ZstEntityBase entity)
    {
        m_events?.on_register_entity_events?.Invoke(entity);
    }

    public override void on_disconnect_cable(ZstCable cable)
    {
        m_events?.on_disconnect_cable_events?.Invoke(cable);
    }
}