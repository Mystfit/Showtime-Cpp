...
class ZstValue : virtual ZstSerialisable<PlugValue, PlugValueBuilder> {
public:
	ZST_EXPORT ZstValue();
	...
	//Serialisation
    ZST_EXPORT flatbuffers::Offset<PlugValue> serialize(PlugValueBuilder & buffer_builder) const override;
