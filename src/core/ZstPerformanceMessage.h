...
public:
	...
	ZST_EXPORT virtual ZstPerformanceMessage * init(ZstMsgKind kind, const std::string & payload) override;
	ZST_EXPORT virtual ZstPerformanceMessage * init(ZstMsgKind kind, const std::string & payload, const ZstMsgArgs & args) override;
};
