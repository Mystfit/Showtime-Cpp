...
public:
	...
	ZstMsgKind aquire_entity_ownership_handler(ZstMessage* msg, ZstPerformerStageProxy* sender);
	ZstMsgKind release_entity_ownership_handler(ZstMessage* msg, ZstPerformerStageProxy* sender);
