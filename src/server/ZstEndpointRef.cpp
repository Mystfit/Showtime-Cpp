...
ZstComponentProxy * ZstEndpointRef::activate_entity(ZstEntityWire & entity)
{
...
ZstPlugRef * ZstEndpointRef::create_plug(const ZstURI & address, ZstPlugDirection direction)
{
