...
./b2 --prefix=$BOOST_ROOT --toolset=gcc --threading=multi $BOOST_FLAGS link=shared stage -d0
./b2 --prefix=$BOOST_ROOT --toolset=gcc --threading=multi $BOOST_FLAGS link=shared install -d0
popd
